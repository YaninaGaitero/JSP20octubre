<%-- 
    Document   : VerHistorialMio
    Created on : 16/10/2014, 18:42:01
    Author     : alumno
--%>
    ...
    <body>
        ...
        <%
            if (request.getMethod() == "POST") {
                ...
                int idComp = Integer.parseInt(BotonID[0]);
                ...
                try {
                    detalles = User.TraerDetallesCliente(idComp);
                } catch (Exception ex) {
                    //Logger.getLogger(VerHistorialMio.class.getName()).log(Level.SEVERE, null, ex);
                }

                Enumeration i = detalles.elements();
                while (i.hasMoreElements()) {
                    try {
                        DetalleCompra auxdet = new DetalleCompra();
