<%-- 
    ...
    Created on : 16/10/2014, 19:22:49
    Author     : alumno
--%>
        ...
        <div class="container">           
            <section id="content">           
                <form name ='formulario' action='RegistrarUsuario.jsp'  method ='POST'>           
                    ...
                    <div>           
                        <input placeholder ='Documento' type='text' id='documento' name='documento'>           
                    </div>           
                    ...
                    <div>           
                        <input placeholder ='Telefono' type='text' id='telefono' name='telefono'>           
                    </div>           
                    <div>           
                        <input placeholder ='Direccion' type='text' id='direccion' name='direccion'>           
                    </div>           
                    <center><div>           
                            <div>           
