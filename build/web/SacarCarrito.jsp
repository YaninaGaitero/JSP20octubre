<%-- 
    Document   : SacarCarrito
    Created on : 16/10/2014, 19:07:32
    Author     : alumno
--%>
    ...
    <body>
        <%
            ...
            out.println("<table border= “1”>"
                    ...
                    + "<td>Cantidad</td>"
                    + "</tr>");
            Enumeration e = DetallesCompra.elements();
            ...
            while (e.hasMoreElements()) {
                ...
                try {
                    out.println("<tr>"
                            ...
                            + "<td><input type ='submit' name='boton' value='" + aux.getIdProd() + "'> </td>"
                            + "</tr>");
                } catch (Exception ex) {
        ...
        <%
            if (request.getMethod() == "POST") {
                session = request.getSession(true);
                Hashtable DetallesCompras = (Hashtable) session.getAttribute("DetallesCompra");
                String[] boton = request.getParameterValues("boton");
